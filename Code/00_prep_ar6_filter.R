...
# These files can be downloaded via https://zenodo.org/records/7197970
...
# READ IN FULL AR6 WORLD DATABASE ----------------------------------------------

# This can be downloaded via https://zenodo.org/records/7197970
ar6_world <- read_csv(here("Data", "pathways", "ar6_all", "AR6_Scenarios_Database_World_ALL_CLIMATE_v1.1.csv"))

ar6_impren <- ar6_world %>% 
  filter(Scenario == "DeepElec_SSP2_ HighRE_Budg900",
         grepl("Infilled", Variable))

# Write to file
ar6_impren %>% 
  write_csv(here("Data", "pathways", "ar6_impren", "emiss_ar6_impren.csv"))
